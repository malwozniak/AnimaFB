...
import { BallBouncingProps } from '../../components/types/Animation';
...
const BallBouncing = styled.div<BallBouncingProps>`
  ...
  animation: ${({ ballSpeedValue, ballMoveValue, ballDistanceValue }) => {
    // console.log("WU", ballDistanceValue, ballSpeedValue, ballMoveValue);
...
const BallBouncingDown = styled.div<BallBouncingProps>`
  transform-origin: bottom;
  animation: ${({ ballSpeedValue, ballMoveValue, ballDistanceValue }) => {
    // console.log("WD", ballDistanceValue, ballSpeedValue, ballMoveValue);
...
const BallBouncingLeft = styled.div<BallBouncingProps>`
  transform-origin: bottom;
  animation: ${({ ballSpeedValue, ballMoveValue, ballDistanceValue }) => {
    // console.log("WL", ballDistanceValue, ballSpeedValue, ballMoveValue);
...
transform-origin: bottom;
animation: ${({ ballSpeedValue, ballMoveValue, ballDistanceValue }) => {
  // console.log("WR", ballDistanceValue, ballSpeedValue, ballMoveValue);
